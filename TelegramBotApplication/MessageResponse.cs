...
namespace View
{
    ...
    public class DictOfEnumsAndResponses
    {
        ...
        {
            dict.Add(ResponseType.Error, "К сожалению, бот не умеет обрабатывать такую команду :-( Отправьте сообщение 'help' или 'помощь', чтобы увидеть все команды бота. P.S. Если вы пытались добавить новую ссылку, то она должна быть корректной :-)");
