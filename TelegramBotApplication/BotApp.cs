...
namespace OOPProject
{
    class BotApp
    {
        ...
        private static async void BotOnMessageReceived(object sender, MessageEventArgs messageEventArgs)
        {
            ...
            //{
            //    var notification = Bot.Domain.Functions.LessonReminder.Do(DateTime.Now.AddMinutes(11));
        ...
        private static async void BotNotificationsSender(object sender, MessageEventArgs messageEventArgs)
        {
            foreach (var id in usersList)
            {
                var message = Bot.Domain.Functions.LessonReminder.Do(DateTime.Now.AddMinutes(11));
